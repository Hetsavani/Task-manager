...
export default function MapFake1() {
    ...
    const arr = [
      ...
          }
        ];
      const[fake,setFake] = useState(arr); 
        ...
        const newArray = fake.map((temp,index) => {
          return (<>
            <div className="card col-4">
              <img src={temp.FacultyImage} className="card-img-top" alt="imgAvatar" />
                <div className="card-body">
                  <div className="row">
                    <div className="col-8">
                    <h5 className="card-title">{temp.FacultyID} {temp.FacultyName}</h5>
                  <p className="card-text">{temp.FacultyDesignation}.</p>
                    </div>
                    <div className='col'>
